...
func Tests() {
	...
	fmt.Println("after Insert RbTree Height: ", RbTreeHeight(rbTree.root))
	PrintRbBinaryTree(rbTree.root)
	fmt.Println()
	rbNode := RbTreeSearch(rbTree.root, IntComparable(2))
	fmt.Println("delete node: ", rbNode)
	rbTree.RbTreeDelete(rbNode)
	PrintRbBinaryTree(rbTree.root)
	fmt.Println()
	rbNode = RbTreeSearch(rbTree.root, IntComparable(4))
	fmt.Println("delete node: ", rbNode)
	rbTree.RbTreeDelete(rbNode)
	PrintRbBinaryTree(rbTree.root)
	fmt.Println()
	rbNode = RbTreeSearch(rbTree.root, IntComparable(3))
	fmt.Println("delete node: ", rbNode)
	rbTree.RbTreeDelete(rbNode)
	PrintRbBinaryTree(rbTree.root)
	fmt.Println()
	rbNode = RbTreeSearch(rbTree.root, IntComparable(1))
	fmt.Println("delete node: ", rbNode)
	rbTree.RbTreeDelete(rbNode)

	fmt.Println("after delete RbTree Height: ", RbTreeHeight(rbTree.root))
	PrintRbBinaryTree(rbTree.root)
	fmt.Println()
